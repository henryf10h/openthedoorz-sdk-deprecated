            ...
            {!walletSession ? (
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <h3 className="text-black font-bold text-sm uppercase tracking-widest">Billetera Conectada</h3>
                    </div>
                    ...
                    <div className="bg-white border border-gray-200 p-4 rounded-lg overflow-hidden">
                        ...
                        <div className="bg-gray-100 border border-gray-200 p-3 rounded mb-3 font-mono">
                            <p className="text-[10px] text-black break-all leading-relaxed tracking-tighter">
                        ...
                        <button
                            ...
                            className="w-full py-2 bg-gray-50 hover:bg-gray-100 text-black text-xs font-bold rounded-lg border border-gray-200 hover:border-gray-300 transition-all flex items-center justify-center gap-2 uppercase tracking-widest"
                        >
                            {copied ? (
                                <>
                        ...
                        <a
                            ...
                            className="w-full mt-2 py-2 bg-gray-50 hover:bg-gray-100 text-black text-xs font-bold rounded-lg border border-gray-200 hover:border-gray-300 transition-all flex items-center justify-center gap-2 uppercase tracking-widest"
                        >
                    ...
                    <button
                        ...
                        className="w-full py-2.5 bg-gray-50 hover:bg-gray-100 text-black text-xs font-bold rounded-lg border border-gray-200 hover:border-gray-300 transition-all flex items-center justify-center gap-2 uppercase tracking-widest"
                    >
                        <Lock size={14} />
